...
export const metadata: Metadata = {
  title: 'How It Works',
  description: `How to join a ${SITE_NAME} outing, what to expect, and how the club keeps outings clear and welcoming.`,
}
    ...
    <main>
      ...
      <section className="how-main page-shell">
        <ol className="how-big-steps">
          ...
          <li><span>02</span><div><p className="technical blue">RSVP</p><h2>Tell us the useful bits.</h2><p>The short Tally form asks about experience, transportation, an optional contact, and anything that would help with planning. It also records which hike you chose.</p></div></li>
          ...
          <li><span>04</span><div><p className="technical blue">SHOW UP</p><h2>Walk at the group’s pace.</h2><p>{SITE_NAME} is about seeing somewhere new together. No one is scored, timed, or expected to perform expertise.</p></div></li>
        </ol>
      </section>
      ...
      <section className="faq page-shell section-space">
        ...
        <details><summary>Is {SITE_NAME} only for U of T students?</summary><p>No. {SITE_NAME} is open to everyone, though the club is primarily shaped around University of Toronto students.</p></details>
